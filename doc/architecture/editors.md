...
- `findCompatibleEditors()` returns the file's natural built-in id plus this board, **without** the `isPlainLocalPath` gate — content-host boards edit `https://` / archive / encrypted files too.
