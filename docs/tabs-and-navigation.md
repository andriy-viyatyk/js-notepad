...
- **Drop files from Windows Explorer** — drag a file or folder from Windows Explorer (or another app) and drop it onto a folder in the tree to copy it in; folders are copied recursively, and dropping onto an existing name asks for confirmation before overwriting.
...
- **Drop files from Windows Explorer** — Drag a file or folder from Windows Explorer (or another app) and drop it onto a folder in the tree to copy it in. Folders are copied recursively, and dropping onto a name that already exists asks for confirmation before overwriting.
