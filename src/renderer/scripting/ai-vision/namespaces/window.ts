...
const WINDOW_MEMBERS: readonly IAiMember[] = [
    ...
    { name: "openMenuBar", kind: "method", signature: "openMenuBar(panelId?: string)", summary: "Open the sidebar, optionally selecting a panel.", caution: "changes the visible UI" },
