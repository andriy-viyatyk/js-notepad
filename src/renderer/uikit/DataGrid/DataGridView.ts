 ...
 *
 * This is deliberately *not* a reconciliation layer (EPIC-057 C4-2). The view is a native host
 * for av-grid's imperative instance: the caller holds rows, columns, focus, selection and the edit path in state
