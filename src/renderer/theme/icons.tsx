...
// Colored tools icon for the "Tools" segment / panel accents — same wrench as ToolsIcon,
// filled with a theme accent color (mirrors BoardColorIcon's role).
export const ToolsColorIcon = createIcon(24)(
    <path
        d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z"
        fill={color.misc.yellow}
    />,
);
...
export const GitIcon = createIcon(32)(
    <path
        d="M 11 4 C 9.355469 4 8 5.355469 8 7 C 8 8.292969 8.84375 9.394531 10 9.8125 L 10 22.1875 C 8.84375 22.605469 8 23.707031 8 25 C 8 26.644531 9.355469 28 11 28 C 12.644531 28 14 26.644531 14 25 C 14 23.730469 13.183594 22.65625 12.0625 22.21875 C 12.207031 20.988281 12.683594 20.382813 13.4375 19.875 C 14.335938 19.269531 15.714844 18.910156 17.21875 18.5625 C 18.722656 18.214844 20.335938 17.855469 21.6875 16.90625 C 22.875 16.074219 23.773438 14.710938 23.96875 12.8125 C 25.140625 12.402344 26 11.300781 26 10 C 26 8.355469 24.644531 7 23 7 C 21.355469 7 20 8.355469 20 10 C 20 11.277344 20.832031 12.351563 21.96875 12.78125 C 21.832031 14.09375 21.324219 14.746094 20.5625 15.28125 C 19.664063 15.910156 18.277344 16.28125 16.78125 16.625 C 15.285156 16.96875 13.664063 17.273438 12.3125 18.1875 C 12.203125 18.261719 12.101563 18.355469 12 18.4375 L 12 9.8125 C 13.15625 9.394531 14 8.292969 14 7 C 14 5.355469 12.644531 4 11 4 Z M 11 6 C 11.5625 6 12 6.4375 12 7 C 12 7.5625 11.5625 8 11 8 C 10.4375 8 10 7.5625 10 7 C 10 6.4375 10.4375 6 11 6 Z M 23 9 C 23.5625 9 24 9.4375 24 10 C 24 10.5625 23.5625 11 23 11 C 22.4375 11 22 10.5625 22 10 C 22 9.4375 22.4375 9 23 9 Z M 11 24 C 11.5625 24 12 24.4375 12 25 C 12 25.5625 11.5625 26 11 26 C 10.4375 26 10 25.5625 10 25 C 10 24.4375 10.4375 24 11 24 Z"
        fill="currentColor"
    />,
);
...
export const GraphGroupIcon = createIcon(24)(
    <g>
        <circle cx="12" cy="12" r="5" fill="#9966cc" />
        <circle cx="12" cy="12" r="9" fill="none" stroke="#9966cc" strokeWidth="1.5" />
    </g>,
);
...
export const VlcIcon = createIcon(24)(
    <g fill="none">
        <path
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            d="m22.43 21.63 -1.9 -5.58c-0.0826 -0.2337 -0.2357 -0.4361 -0.438 -0.5794 -0.2023 -0.1433 -0.4441 -0.2203 -0.692 -0.2206h-1.54l0.48 1.48c0.053 0.1737 0.0578 0.3585 0.0138 0.5347 -0.0441 0.1762 -0.1353 0.337 -0.2638 0.4653 -0.73 0.73 -2.51 2 -6.09 2 -3.58001 0 -5.36001 -1.28 -6.09001 -2 -0.12854 -0.1283 -0.21973 -0.2891 -0.26377 -0.4653 -0.04405 -0.1762 -0.03928 -0.361 0.01377 -0.5347l0.48 -1.48h-1.54c-0.24792 0.0003 -0.48967 0.0773 -0.69201 0.2206 -0.20234 0.1433 -0.35535 0.3457 -0.43799 0.5794l-1.9 5.58c-0.06322 0.1845 -0.08169 0.3813 -0.05387 0.5743 0.02782 0.193 0.10113 0.3766 0.21387 0.5357 0.11248 0.1601 0.26239 0.2902 0.43669 0.3791 0.17429 0.0889 0.36768 0.1339 0.56331 0.1309H21.28c0.1956 0.003 0.389 -0.042 0.5633 -0.1309 0.1743 -0.0889 0.3242 -0.219 0.4367 -0.3791 0.1111 -0.1599 0.1826 -0.344 0.2087 -0.5369 0.026 -0.193 0.0059 -0.3894 -0.0587 -0.5731Z"
            strokeWidth="1.5"
        />
        <path
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="m14.34 4.19003 -0.71 -2.25c-0.1098 -0.34619 -0.3269 -0.64843 -0.62 -0.86294 -0.2931 -0.21451 -0.6468 -0.330142 -1.01 -0.330142 -0.3632 0 -0.7169 0.115632 -1.01 0.330142 -0.2931 0.21451 -0.5102 0.51675 -0.62 0.86294l-0.71 2.25c0.7252 0.36775 1.5269 0.55959 2.34 0.56 0.8131 -0.00041 1.6148 -0.19225 2.34 -0.56Z"
            strokeWidth="1.5"
        />
        <path
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M15.59 8.10999c-1.05 0.74212 -2.3042 1.1406 -3.59 1.1406s-2.54 -0.39848 -3.59001 -1.1406l-1.51 4.74001c1.52893 0.9498 3.30041 1.4361 5.10001 1.4 1.7996 0.0361 3.5711 -0.4502 5.1 -1.4l-1.51 -4.74001Z"
            strokeWidth="1.5"
        />
        <path
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="m6.13998 15.2501 3.52 -11.06004"
            strokeWidth="1.5"
        />
        <path
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M17.86 15.2501 14.34 4.19006"
            strokeWidth="1.5"
        />
    </g>,
);
